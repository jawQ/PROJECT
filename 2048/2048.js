...
function setWidthHeight() {
  ...
  var height=window.innerHeight-$("#score").height();//啥玩意?

  var cell_width=height/(4/21);
  var cell_height=width/(4/21);
  var base_marginLeft=cell_width/4;
  var base_marginTop=cell_height/4;
}
